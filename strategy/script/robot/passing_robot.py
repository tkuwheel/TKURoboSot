...
from vision.msg import PassingObject
...
class Robot(object):
  ...
  def __init__(self, sim = False):
    ...
    rospy.Subscriber(VISION_TOPIC, PassingObject, self._GetVision)
  ...
  def _GetVision(self, vision):
    ...
    self.__object_info['Red']['dis']    = vision.red_dis
    self.__object_info['Red']['ang']    = vision.red_ang
    self.__object_info['White']['dis']    = vision.white_dis
    self.__object_info['White']['ang']    = vision.white_ang
