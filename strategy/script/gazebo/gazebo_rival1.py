...
NUBOT_OMNI_VISION = "/rival1/omnivision/OmniVisionInfo"
NUBOT_SHOOT_SRV   = "/rival1/Shoot"
NUBOT_HANDLE_SRV  = "/rival1/BallHandle"
...
def OmniVisionCallback(data):
    ...
    ra = data.robotinfo[1 -1].heading.theta+3.14
