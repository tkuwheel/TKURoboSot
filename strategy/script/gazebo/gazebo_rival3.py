...
NUBOT_OMNI_VISION = "/rival3/omnivision/OmniVisionInfo"
NUBOT_SHOOT_SRV   = "/rival3/Shoot"
NUBOT_HANDLE_SRV  = "/rival3/BallHandle"
...
def OmniVisionCallback(data):
    ...
    ra = data.robotinfo[3 -1].heading.theta+3.14
